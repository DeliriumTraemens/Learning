...
//        int[] result = new int[2];
        ...
        for (int i = 0; i < nums.length; i++) {
            int complement=target-nums[i];
                            ...
                            System.out.println("Current complement = "+complement+" - is diff of target "+target+"-"+nums[i]);
//                            System.out.println("map contains required number "+map.containsKey(complement));
...
//
            ...
            System.out.println("we add the number "+nums[i] +" , stored in index "+i);
            map.put(nums[i], i);
